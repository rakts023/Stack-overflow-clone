...
const QuestionDetails = () => {
    ...
    const handlePostAns = (e, answerLength) => {
        ...
        if( User === null){
            ...
            if(Answer === ''){
                alert('Enter Answering before submitting')
            }else{
  ...
  return (
    <div className='question-details-page'>
       {/* <h1>hello</h1> */}
       { 
        questionList.data === null ? //data
        <h1>Loading...</h1> :
        <>
            {
                questionList.data.filter(question => question._id === id).map(question => (  //data
                    <div key={question._id}>
                        ...
                        <section className='post-ans-container'>
                            ...
                            <p>
                                ...
                                <Link to='/AskQuestions' style={{textDecoration:'none' , color:'#009dff'}}> ask your question</Link>
                            </p>
                        </section>
                    </div>
                ))
